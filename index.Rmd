...
# .center[**Caution**: WTP space models are not linear-in-parameters]

## .center[Use a multistart optimization loop]

.leftcol[
### Preference Space

**Convex** log-likelihood function `emo::ji("tada")`

<center>
<img src="images/utilityPreference2.png" width=400>
</center>
]
...
**Non-convex** log-likelihood function `emo::ji("sad")`
...
# .center[In WTP Space, Use a Multistart]
