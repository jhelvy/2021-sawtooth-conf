...
### .purple[WTP space models produce immediately interpretable results</br>(with correct standard errors)]
...
### .purple[WTPs can be directly compared across different models</br>(even estimates from different data sets)]
...
In a preference space model, model parameters are proportional to the scale term which can vary across different data sets; as a result, preference space coefficients cannot be directly compared across different models estimated on different data sets. This poses a challenge for comparative studies or literature reviews that seek to compare outcomes on similar topics across multiple studies.
