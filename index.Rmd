...
.rightcol60[
Standard error on $\hat{\omega}$ requires assumption that</br> $\hat{\alpha}$ & $\hat{\beta}$ have asymptotically normal distributions .gray[(Bockstael and Strand, 1987)]
...
## .center[Mixed logit: Large WTP variance across population]
